...
namespace MyWebsite.Controllers
{
    public class SoftwaresController : Controller
    {
        ...
        public SoftwaresController(SoftwareContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,FreeTrial,StartingPrice,Link,Description,Deployment,Training,Support")] Software software)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,FreeTrial,StartingPrice")] Software software)
        {
            if (id != software.Id)
            {
                return NotFound();
